...
var _getStudentsAPI = require("./services/getStudentsAPI");
var _deleteStudentsAPI = require("./services/deleteStudentsAPI");
var _addStudentsAPI = require("./services/addStudentsAPI");
var _updateStudentsAPI = require("./services/updateStudentsAPI");
...
document.getElementById("get-students-btn").addEventListener("click", function() {
    (0, _getStudentsAPI.getStudentsApi)().then((students)=>createLayout(students)).catch((error)=>{
...
document.getElementById("students-table").addEventListener("click", (event)=>{
    if (event.target.classList.contains("edit__btn")) {
        ...
        document.getElementById("modal-name").value = event.target.parentNode.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
        document.getElementById("modal-age").value = event.target.parentNode.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
        document.getElementById("modal-course").value = event.target.parentNode.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
        document.getElementById("modal-skills").value = event.target.parentNode.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
        document.getElementById("modal-email").value = event.target.parentNode.previousElementSibling.previousElementSibling.textContent;
        if (event.target.parentNode.previousElementSibling.textContent === "\u0417\u0430\u0440\u0430\u0445\u043E\u0432\u0430\u043D\u043E") document.getElementById("modal-isEnrolled").checked = true;
        else document.getElementById("modal-isEnrolled").checked = false;
...
document.getElementById("add-student-form").addEventListener("submit", (event)=>{
    ...
    const obj = {
        ...
        skills: document.getElementById("skills").value.trim().split(",").map((item)=>item.trim()).filter((item)=>item !== ""),
...
document.getElementById("change-student-form").addEventListener("submit", (event)=>{
    ...
    const obj = {
        ...
        skills: document.getElementById("modal-skills").value.trim().split(",").map((item)=>item.trim()).filter((item)=>item !== ""),
...
},{}],"cy75b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=students-list-practice.1fcc916e.js.map
